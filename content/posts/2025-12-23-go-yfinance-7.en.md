...
date: "2025-12-23"
slug: "go-yfinance-7"
summary: "The seventh post in a series about building a Go version of the Yahoo Finance library based on Python's yfinance, utilizing Claude Code."
description: "The seventh post in a series about building a Go version of the Yahoo Finance library based on Python's yfinance, utilizing Claude Code."
toc: true
readTime: true
autonumber: false
math: true
...
In the [previous post](https://wnjoon.github.io/go-yfinance-3/), I mentioned that I planned to create documentation for each method and convert it into a static page. So, I used MkDocs to convert the [API documentation](https://github.com/wnjoon/go-yfinance/blob/main/docs/API.md) into a static page.
