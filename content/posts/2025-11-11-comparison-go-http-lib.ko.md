...
summary: "fasthttp vs net/http 중 어느 것을 사용하는게 좋은지, 그리고 왜 fasthttp는 HTTP/2를 지원하지 않는지에 대해 알아봅니다."
description: "fasthttp vs net/http 중 어느 것을 사용하는게 좋은지, 그리고 왜 fasthttp는 HTTP/2를 지원하지 않는지에 대해 알아봅니다."
toc: true
readTime: true
autonumber: false
math: true
tags: ["dev", "go", "2025"]
keywords: ["go", "http", "fasthttp", "net/http", "성능", "서버 프레임워크", "HTTP/2"]
showTags: true
hideBackToTop: false
aliases: 
  - /2025/11/11/comparison-go-http-lib/
