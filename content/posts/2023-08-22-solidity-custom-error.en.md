...
date: "2023-08-22"
slug: "solidity-custom-error"
summary: "Custom errors are a new feature in Solidity v0.8.4 that allow developers to define custom error types."
...
keywords: ["blockchain", "ethereum", "solidity", "smartcontract", "custom error"]
showTags: true
hideBackToTop: false
aliases:
  - /2023/08/22/blockchain-custom-error-solidity/
# fediverse: "@username@instance.url"
schema:
  "@context": "https://schema.org"
  "@type": "Article"
  "headline": "Custom Errors in Solidity: A Gas-Efficient Alternative"
  "description": "Custom errors are a new feature in Solidity v0.8.4 that allow developers to define custom error types."
  "keywords": "ethereum, solidity, smartcontract, custom error"
  "author": {
    "@type": "Person",
    "name": "wonjoon"
  }
