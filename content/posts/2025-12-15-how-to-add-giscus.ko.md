...
date: "2025-12-15"
slug: "add-giscus"
summary: "Giscus를 이용하여 Github Pages로 만든 블로그에 댓글 기능을 추가하는 방법을 소개합니다."
description: "Giscus를 이용하여 Github Pages로 만든 블로그에 댓글 기능을 추가하는 방법을 소개합니다."
toc: true
readTime: true
autonumber: false
math: true
