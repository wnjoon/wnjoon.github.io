---
title: "AI만 가지고 아주 작은 dApp 만들기"
author: "wonjoon"
authorAvatarPath: "/avatar.jpeg"
date: "2025-09-15"
slug: "tiny-dapp-with-ai"
summary: "프론트엔드에 대해 전혀 모르는 백엔드 개발자가 AI만 사용해서 매우 작은 AMM 기반 dApp을 개발해보는 과정을 정리했습니다."
...
keywords: ["Uniswap", "AMM", "dApp", "AI", "frontend development", "gemini", "claude code", "windsurf", "프론트엔드 개발"]
showTags: true
hideBackToTop: false
aliases:
  - /2025/09/15/miniamm-dapp-with-ai/
...
schema:
  ...
  "headline": "AI만 가지고 아주 작은 dApp 만들기"
  "description": "프론트엔드에 대해 전혀 모르는 백엔드 개발자가 AI만 사용해서 매우 작은 AMM 기반 dApp을 개발해보는 과정을 정리했습니다. 이 모든 과정은 Hell-Month라고 하는 단기 프로젝트에서 진행하였습니다."
  "keywords": "Uniswap, AMM, dApp, AI, frontend development, gemini, claude code, windsurf, 프론트엔드 개발"
  "mainEntity": 
    "@type": "FAQPage"
...
[간단하게 Uniswap을 구현해본 웹사이트](https://6b2d0ce4.miniamm-dapp.pages.dev/)입니다. 
