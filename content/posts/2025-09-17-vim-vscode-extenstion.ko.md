...
date: "2025-09-17"
slug: "vim-vscode-extension"
summary: "claude code를 사용해서 vscode extension을 만들어본 경험을 공유합니다."
...
autonumber: false
math: true
tags: ["dev", "ai", "vim", "vscode", "claude code", "2025"]
keywords: ["AI", "Claude Code", "vim cheatsheet", "vscode extension", "바이브 코딩"]
showTags: true
hideBackToTop: false
aliases: 
  - /2025/09/17/vim-vscode-extenstion/
