---
title: "How to track gas consumption in Cosmos SDK"
author: "wonjoon"
authorAvatarPath: "/avatar.jpeg"
date: "2025-03-12"
slug: "track-gas-consumption-in-cosmos-sdk"
summary: "Cosmos SDK provides a GasKVStore that tracks gas consumption in real-time during transaction execution."
...
autonumber: false
math: true
tags: ["dev", "cosmos-sdk", "2025"]
keywords: ["cosmos-sdk", "blockchain", "gaskvstore", "gas consumption", "kvstore"]
showTags: true
hideBackToTop: false
aliases:
  - /2025/03/12/cosmos-sdk-gaskvstore/
# fediverse: "@username@instance.url"
schema:
  "@context": "https://schema.org"
  "@type": "Article"
  "headline": "How to track gas consumption in Cosmos SDK"
  "description": "GasKVStore is a core component of the Cosmos SDK that tracks gas consumption in real-time during transaction execution. It ensures every read, write, and delete operation consumes gas, preventing transactions from exceeding their gas limits."
  "keywords": "cosmos-sdk, blockchain, gaskvstore, gas consumption, kvstore"
  "author": {
    "@type": "Person",
...
Here is a table of core methods of GasKVStore:
