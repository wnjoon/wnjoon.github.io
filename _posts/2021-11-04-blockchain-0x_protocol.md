---
layout: post
title: "거래소 없이 토큰을 거래하기 위한 0xProtocol"
excerpt: "거래소에 의존하지 않고 다양한 토큰을 거래하기 위한 공통 프로토콜인 0x프로토콜은, 스마트 컨트랙트로 작성되어 중간자를 경유하는 코스모스나 비트쉐어와 달리 직접 이더리움 상에서 토큰을 거래할 수 있도록 한다."
description: "Description of the 0xProtocol, a common protocol for trading various tokens without relying on exchanges"
date: 2021-11-04 15:00:00 +0900
categories: 블록체인
tags: [ethereum, protocol]
keywords: [ethereum, protocol, 0xprotocol]
comments: true
---

<br>

## 거래소로부터의 탈피를 위한 공통 프로토콜
...
<p align="center" style="color:gray">
  <img src="https://user-images.githubusercontent.com/39115630/140250276-8add59e5-7f7b-4771-b9aa-5cf567b9e628.png" alt="0x 프로토콜의 동작 방식 1" />
  <br />
  0x 프로토콜의 동작 방식 1 (출처 : 백서)
</p><br>
...
<p align="center" style="color:gray">
  <img src="https://user-images.githubusercontent.com/39115630/140251868-67b5189e-3b25-45a4-9ccf-4790e8fca277.png" alt="0x 프로토콜의 동작 방식 2" />
  <br />
  0x 프로토콜의 동작 방식 2 (출처 : 백서)
</p><br>
...
## Off-chain과 On-chain을 섞은 하이브리드 방식
