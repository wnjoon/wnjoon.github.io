---
layout: post
title: "이더리움의 가상머신, EVM(Ethereum Virtual Machine)"
...
description: "Description of EVM, which stands for Ethereum’s virtual machine."
date: 2023-01-31 15:00:00 +0900
categories: 블록체인
tags: [ethereum]
keywords: [blockchain, ethereum, virtual machine]
comments: true
---
...
EVM은 스마트 컨트랙트 작성이 가능한 솔리디티 등 여러 고수준의 프로그램이 언어를 컴파일하여 자체적인 바이트 코드 명령어 집합을 실행할 수 있도록 한다.
