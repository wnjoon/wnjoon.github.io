...
excerpt: "HD wallet은 하나의 마스터 키로부터 다수의 키들을 계층적으로 파생할 수 있는 지갑으로, 파생된 키들이 규칙을 갖기 때문에 마스터 키만 잘 보존된다면 키의 생성 및 복구가 용이하다는 장점이 있다. 본 포스팅에서는 HD wallet에 대하여 알아보고, 이를 go로 직접 구현한 리포지토리를 하단에 공유한다."
description: "Description of HD wallet and sharing of repository implementing it in go language."
date: 2021-08-06 15:00:00 +0900
categories: 블록체인
tags: [ethereum, wallet]
keywords: [blockchain, ethereum, wallet]
comments: true
---
...
2. 유연성 : 초기 HD wallet의 표준이었던 BIP-32, BIP-39가 비트코인에 한정된 기능을 제공하였다면, BIP-44에서는 이더리움을 포함한 다양한 암호화폐에서도 HD wallet을 적용할 수 있도록 하였다.
