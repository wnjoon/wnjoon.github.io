...
description: "An introduction to 15 ways to write good REST APIs."
date: 2022-11-08 15:00:00 +0900
categories: 아키텍처
tags: [design pattern, rest api]
keywords: [software architecture, dex, defi, blockchain]
comments: true
---
...
<p align="center" style="color:gray">
  <img src="https://res.cloudinary.com/practicaldev/image/fetch/s--YTDTEgpk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://dev-to-uploads.s3.amazonaws.com/i/ekawmj3rafdtn06hzj79.png" alt="REST API의 개략적인 구조" />
  <br />
...
위에서 권장한 방법대로라면, 1번이 옳은 것이다. 이미 GET이라는 HTTP 메소드가 해당 API의 역할을 충분히 설명하고 있기 때문에, 마지막 경로에 동사를 넣게 되면 중복된 설명이 된다.
