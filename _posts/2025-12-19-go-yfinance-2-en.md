...
description: "The third post covering the story of building a Go version of the yahoo finance library based on the Python yfinance library using Claude Code."
categories: dev
draft: false
lang: en
...
schema:
  ...
  "@type": "Article"
  "headline": "Building a Go version of the yahoo finance library using Claude Code #3"
  "description": "The third post covering the story of building a Go version of the yahoo finance library based on the Python yfinance library using Claude Code."
  "keywords": "AI, Claude Code, python, yfinance, go, yahoo finance"
---
...
Today, I guided it to implement 'up to a practical level (~Phase 4)' and wrote a [blog post](https://wnjoon.github.io/2025/12/19/go-yfinance-1-en/) about it. But suddenly, a question arose.
