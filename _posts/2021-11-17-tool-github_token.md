---
layout: post
title: "Token 기반의 Github 리포지토리 인증 방식 적용하기"
excerpt: "깃헙의 정책에 따라 2021년 8월부터 변경된 토큰 기반 인증방식을 리포지토리에 적용하는 방법에 대해 알아본다."
description: "Description of token-based GitHub authentication"
date: 2021-11-17 15:00:00 +0900
categories: tips
tags: [github, authorization]
keywords: [github, authorization]
comments: true
---

<br>

## 패스워드 기반 인증 서비스 방식의 중단
...
참고로 최종 생성된 토큰값은 페이지를 나가면 더이상 확인할 수 없기 때문에 별도의 공간에 잘 보관해야 한다. _(물론 잊어버리면 다시 생성하면 그만이지만 귀찮기 때문)_
