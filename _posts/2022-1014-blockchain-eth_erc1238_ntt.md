...
excerpt: "배지(Badge)란, 거래가 불가능한 속성을 갖는 토큰을 의미한다. 사용자의 경험에 대한 산물일 수도 있고, 혹은 명예 또는 자격증과 같은 성격을 가질 수도 있다. 현재 ERC-1238이라는 형태의 토큰으로 만들 수 있으며, 또 다른 이름으로 NTT라고 불리기도 한다."
