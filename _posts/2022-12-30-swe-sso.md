---
layout: post
title: "한번의 로그인을 통해 여러 어플리케이션 접근이 가능하도록 하는 SSO(Single Sign On)"
...
description: "Description of SSO, which grants access to multiple applications through single authentication from an authenticated location."
date: 2022-12-30 15:00:00 +0900
categories: 아키텍처
tags: [security, authentication]
keywords: [software architecture, security, authentication, sso]
comments: true
---
...
Access Token, Refresh Token을 활용한 방식은 OAuth와 동일하다. 단 로그인 과정에서 ID Token(id_token)을 별도로 발급받아 해당 토큰으로 사용자를 손쉽게 인증할 수 있다는 차이점이 있다.
