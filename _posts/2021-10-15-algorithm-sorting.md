---
layout: post
title: "퀵 정렬과 병합 정렬에 대한 비교"
excerpt: "다양한 정렬(sorting) 알고리즘이 있지만, 가장 일반적으로 사용되는 것은 퀵(quick)과 병합(merge)이 있다. 본 포스팅에서는 각 정렬 알고리즘에 대해 알아보고, 이를 Java를 이용하여 배열 형태로 구현해본다."
description: "Explains quick sort and merge sort, and implements each algorithm in the form of an array using Java."
date: 2021-10-15 15:00:00 +0900
categories: 알고리즘
tags: [data structure]
keywords: [algorithm, data structure, sorting]
comments: true
---

<br>

## 정렬 알고리즘을 구현하는 2가지 방식
