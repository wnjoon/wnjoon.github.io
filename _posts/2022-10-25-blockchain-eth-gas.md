---
layout: post
title: "이더리움 생테계에서 노력과 가치를 표현하기 위해 존재하는 가스"
excerpt: "가스는 목표 해시 값을 계산해 낸 채굴자에 대한 보상으로 제공되는 수수료를 의미하는데, EVM 상에서 트랜잭션을 동작시키기 위한 필수적인 비용으로 생각하는게 더 편하다. 하루에도 수없이 가격이 바뀌는 이더의 가격으로 수수료를 매기는 잘못된 방법을 피하기 위해, 이더리움에서는 일정한 가격을 가진 가스라는 단위를 만들어서 사용한다. 그렇다고 가스가 꼭 보상만을 위해 존재하는 것은 아니다. 이더리움 네트워크가 지속적으로 동작할 수 있도록 사용자들의 트랜잭션 사용량을 제한하기 위해서도 가스는 사용된다."
description: "Description of the gas that exists on Ethereum for rewards to miners and stability of the network and fees."
...
<p align="center" style="color:gray">
  <img src="https://miro.medium.com/max/720/1*mI8hVfDXdLMWsw89zzdjvg.png" alt="기능 별로 필요한 가스의 개수" />
  <br />
   기능 별로 필요한 가스의 개수
</p><br>

이더리움은 [황서(yellow paper)](https://ethereum.github.io/yellowpaper/paper.pdf)를 통해 실행되는 코드 별 필요한 가스량을 명시해두었다.  
사실 이더리움이 아닌 일반적인 시스템에서도 기능에 따라 필요한 자원량이 달라진다. 예를 들어, 간단한 워드 작업이나 인터넷 서핑은 큰 자원을 요구하지 않지만, 고사양의 게임을 하거나 동영상을 인코딩 하는 작업 등에서는 꽤 많은 자원이 필요하다.
...
<p align="center" style="color:gray">
  <img src="https://velog.velcdn.com/images/wnjoon/post/4e5ede64-9598-4a25-b50b-b1c8c533ebd9/image.png" alt="하루 동안 변화된 이더리움 가격" />
  <br />
   하루 동안 변화된 이더리움 가격
</p><br>
...
그럼 가스비는 이더로 표현되는가? 아니다. 가스비는 Gwei라는 단위로 표현된다. 1 Eth = 1,000,000,000 Gwei = 1,000,000,000,000,000,000 Wei이 된다.
