---
layout: post
title: "그래프(Graph) 구조와 탐색 알고리즘"
excerpt: "그래프는 노드와 노드를 연결하는 간선(edge)의 모음으로, 트리와 같은 구조가 그래프에 해당한다. 특히 그래프 탐색 방법은 코딩테스트에서 가장 많이 나오는 유형으로, 깊이 우선 탐색(DFS)과 넓이 우선 탐색(BFS) 방법이 있다."
description: "Description of bfs and dfs, search algorithms using graph algorithms"
date: 2021-09-15 15:00:00 +0900
categories: 알고리즘
tags: [searching algorithm]
keywords: [algorithm, searching, graph, dfs, bfs]
comments: true
---
