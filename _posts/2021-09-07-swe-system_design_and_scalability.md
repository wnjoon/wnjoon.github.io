...
description: "Share what I've learned about designing scalable systems"
date: 2021-09-07 15:00:00 +0900
categories: 아키텍처
tags: [system design]
keywords: [software architecture, system design, scalability]
comments: true
---

<br>

## TinyURL을 예시로 한 시스템 설계 방법

URL을 축소해서 이를 원래 URL과 매핑해주는 시스템(TinyURL)을 설계한다고 가정하자.
...
### 1. 수평적(horizontal) vs 수직적(vertical) 규모 확장
