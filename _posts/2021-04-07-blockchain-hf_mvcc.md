---
layout: post
title: "다중 버전 동시성 제어(MVCC)와 하이퍼레저 패브릭 간의 관계"
excerpt: "기본적으로 LevelDB를 사용하는 하이퍼레저 패브릭 특성상, 집중적으로 유입되는 수많은 트랜잭션 요청으로 인한 동시성 제어 문제가 발생할 수 있다. 본 포스팅에서는 데이터베이스에 발생할 수 있는 다중 버전 동시성 제어와 하이퍼레저 패브릭에서 동시성 제어를 위해 사용할 수 있는 몇가지 팁을 공유한다."
description: "Describes multi-version concurrency control that can occur in databases and explains how to prevent errors in Hyperledger Fabric."
date: 2021-04-07 15:00:00 +0900
categories: [블록체인, 데이터베이스]
tags: [hyperledger fabric]
keywords: [database, mvcc, blockchain, hyperledger fabric]
comments: true
---
