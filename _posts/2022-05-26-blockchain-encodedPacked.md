---
layout: post
title: "Web3js에서 합친 문자열을 솔리디티에서 동일하게 사용하기 위한 solidityPack"
excerpt: "솔리디티에서는 문자열을 조합할때 encodedPack 함수를 사용한다. 그렇다면 Web3js에서 가공한 문자열을 솔리디티 내부에서 동일하게 확인할 수 있는 방법이 있을까? 본 포스팅에서는 솔리디티에서 encodedPack을 통해 가공한 문자열을 web3js에서 동일하게 확인할 수 있는 solidityPack 함수에 대해 알아본다."
description: "Description of web3js' solidityPack, which generates strings of the same standard as encodedPack, which generates strings in Solidity."
date: 2022-05-26 15:00:00 +0900
categories: 블록체인
tags: [ethereum, smart contract, web3js]
keywords: [blockchain, ethereum, keccak, web3js]
comments: true
---
