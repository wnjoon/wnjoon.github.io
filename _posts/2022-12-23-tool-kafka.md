---
layout: post
title: "대량의 실시간 데이터를 빠르고 안전하게 처리하기 위한 분산형 플랫폼, 카프카"
...
description: "Description of Kafka, a distributed data streaming platform."
date: 2022-12-23 15:00:00 +0900
categories: 아키텍처
tags: [kafka, distribution system]
keywords: [software architecture, kafka, distribution system]
comments: true
---
...
<p align="center" style="color:gray">
  <img src="https://user-images.githubusercontent.com/39115630/209517275-c2b158c6-01d8-47f1-b15f-a01e1201f57d.png" alt="어플리케이션의 다양화로 인하여 복잡해진 데이터 라인" />
  <br />
   어플리케이션의 다양화로 인하여 복잡해진 데이터 라인
</p><br>
...
<p align="center" style="color:gray">
  <img src="https://user-images.githubusercontent.com/39115630/209498379-9f169a13-7c74-4575-af84-71e5049b29d7.png" alt="아파치 카프카는 다양한 앱을 하나의 플랫폼에서 간편하게 구독, 처리할 수 있도록 하는 플랫폼이다" />
  <br />
   아파치 카프카는 다양한 앱을 하나의 플랫폼에서 간편하게 구독, 처리할 수 있도록 하는 플랫폼이다 (출처 : 데브원영)
</p><br>
...
<p align="center" style="color:gray">
  <img src="https://user-images.githubusercontent.com/39115630/209517445-4d67d84c-0da9-4d47-847b-85dd2e8c89c2.png" alt="아파치 카프카를 통해 데이터를 송수신하는 구조" />
  <br />
   아파치 카프카를 통해 데이터를 송수신하는 구조
</p><br>
...
<p align="center" style="color:gray">
  <img src="https://user-images.githubusercontent.com/39115630/209517498-68e12f8b-092d-47a7-ac92-9a85a3bb9e94.png" alt="카프카에서 데이터 처리에 사용되는 큐, 토픽" />
  <br />
   카프카에서 데이터 처리에 사용되는 큐, 토픽
</p><br>
...
<p align="center" style="color:gray">
  <img src="https://user-images.githubusercontent.com/39115630/209517559-f91efd2b-8c6a-4271-9b1c-add89e7087a6.png" alt="토픽의 파티션" />
  <br />
   토픽의 파티션
</p><br>
...
<p align="center" style="color:gray">
  <img src="https://user-images.githubusercontent.com/39115630/209517629-d3b2010d-ef03-4fc8-ac67-f934bad93890.png" alt="고가용성을 위한 ISR(In Sync Replica) 구조" />
  <br />
   고가용성을 위한 ISR(In Sync Replica) 구조
</p><br>
...
<p align="center" style="color:gray">
  <img src="https://user-images.githubusercontent.com/39115630/209518144-06a6f576-a118-49f3-b9f8-dc803ea95ea3.png" alt="프로듀서에서 생성한 데이터의 파티션 위치를 결정하는 파티셔너" />
  <br />
   프로듀서에서 생성한 데이터의 파티션 위치를 결정하는 파티셔너
</p><br>
...
<p align="center" style="color:gray">
  <img src="https://user-images.githubusercontent.com/39115630/209518167-0daa77dd-cfe5-4f6e-83a5-9c7ecd444717.png" alt="프로듀서와 컨슈머 사이의 데이터 처리량 차이에서 발생하는 컨슈머 랙" />
  <br />
   프로듀서와 컨슈머 사이의 데이터 처리량 차이에서 발생하는 컨슈머 랙
</p><br>
