...
excerpt: "사이드체인에 대하여 개인적으로 정리한 생각과 이를 활용한 사례들에 대해 정리한다."

categories:
  -  Blockchain
tags:
  - [Blockchain, Sidechain, 상호운용성]
...
비트코인과 같이 스마트컨트랙트가 존재하지 않는 메인체인에 이더리움을 사이드체인으로 연결함으로써, 비트코인에서도 스마트컨트랙트 사용이 가능하게 할 수 있다.  
단적인 예로 크립토키티([cryptokitties](https://www.cryptokitties.co))는 메인체인을 비트코인으로 사용하면서 이더리움을 사이드체인으로 사용하는 것으로 알려져 있다.  
