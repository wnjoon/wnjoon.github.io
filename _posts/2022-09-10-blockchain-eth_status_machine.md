---
layout: post
title: "계산이론 과목에서 보던 상태머신으로 바라본 이더리움"
excerpt: "학부시절 계산이론 과목은 도대체 무슨 말을 하는건지 이해하기 어려운, 개념과 이론의 연속이었다. 그런데 이더리움을 공부하던 중 갑자기 잊고있던 상태머신이 언급되었고, 이더리움이 상태머신이라고 한다. 왜 이더리움은 상태머신일까? 그리고 상태머신이라는건 뭘까? 이번 포스팅을 통해 간단하게나마 알아본다."
description: "An explanation of why Ethereum is a state machine."
date: 2022-09-10 15:00:00 +0900
categories: 블록체인
tags: [ethereum, state machine]
keywords: [blockchain, ethereum, state machine]
comments: true
---
