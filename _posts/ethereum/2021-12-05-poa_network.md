...
#### 2.2. extraData
PoA 환경에서 블록을 생성(채굴)하는 주체인 Authority들의 목록을 저장한다. 만약 주소가 0xabcd라고 할 때, 0x를 제외한 abcd를 0x00000.....0 뒤에 차례대로 추가해주면 된다. 그 뒤에 있는 000...000은 그대로 두어야 한다. 본 예시에서는 테스트 환경을 위한 PoA 구성이라는 특성에 맞추어 하나의 Authority만을 추가한다.
