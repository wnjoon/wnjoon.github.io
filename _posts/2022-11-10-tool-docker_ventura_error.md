---
layout: post
title: "맥 OS 업데이트 이후에 Docker가 갑자기 동작하지 않을 때"
...
description: "Introducing a solution if Docker suddenly does not work after Mac OS update."
...
[2022년 10월 24일, Ventura가 출시된 날](https://www.apple.com/kr/newsroom/2022/10/macos-ventura-is-now-available/)에 맞춰 신나게 맥 OS를 업데이트했다. _이 때 까지만 해도, 오류가 계속해서 생겨날지는 꿈에도 몰랐다._  
