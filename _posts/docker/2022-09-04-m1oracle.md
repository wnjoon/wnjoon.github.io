---
title:  "M1에서 x86/64 기반의 컨테이너 구동하기" 
excerpt: "M1 맥북에서 동작하지 않던 x86/64 기반의 컨테이너를 Colima를 이용하여 구동해본다"
...
[Shane's Planet](https://shanepark.tistory.com/400) 블로그에서 발췌한 내용으로, 오픈소스 컨테이너 런타임 중 하나인 Colima를 이용하면 Oracle 컨테이너를 M1에서도 구동할 수 있다.  
